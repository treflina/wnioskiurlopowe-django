...
class User(AbstractBaseUser):
    ...
    # trzeba dopisać w base.py AUTH_USER
    ...
    position_addinfo = models.CharField('Dopisek "sprz."', max_length=50, blank =True)
    ...
    # potrzebne żeby wiedzieć kto może sprawować funkcje administradora
